...
try {
	...
	$insert = $bdd->prepare('INSERT INTO inscriptions(nom, tel, mail, nbrMembres, nonMembres, soutien, membres, bolognaise, carbonara, pesto, remarque) VALUES(:nom, :tel, :mail, :nbrMembres, :nonMembres, :soutien, :membres, :bolognaise, :carbonara, :pesto, :remarque)');
