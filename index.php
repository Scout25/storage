<?php
$head_title = "L'unité du Porc-épic 25, scouts et guides pluralistes de Ganshoren, Bruxelles-Norois";
                ...
                <div class="row">
                    <div class="col-xs-12 col-md-6">
                        <article>
                            <h3>Castors : </h3>
                            <br/>
                            <p class="p1 lead">Ferrières du 16 au 22 juillet 2016</p>
                            <h3>Scouts :</h3>
                            <br/>
                            <p class="p1 lead">Paliseul du 16 au 31 juillet 2016</p>
                        </article>
                    </div>
                    <div class="col-xs-12 col-md-6">
                        <article>
                ...
                <div class="row">
                    <div class="col-md-6 col-md-offset-3 text-center bg_white">
                        <p class="section-mail blue">
                            ...
                            <a href="mailto:unite&#64scout25.be?subject=Envoyé depuis scout25.be">
                                unite&#64;scout25.be
                            </a>
                        </p>
                    </div>
