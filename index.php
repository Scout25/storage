...
<body>
    ...
    <div id="top" class="header">
        <div class="vert-text">
            <div class="left">
                ...
                <br/>
                <a href="#services" id="bouton_intro" class="btn btn-lg btn-default littles">Poursuivre</a>
            </div>
        </div>
    </div>
    <!-- /Full Page Image Header Area -->
 ...
 <!--              
    ...
    <!-- Services -->
    <div id="services_index" class="services_index">
        <div class="container">
            <div class="row">
                <div class="col-md-4 col-md-offset-4 text-center">
            ...
            <div class="row">
                <div class="col-md-6 column col-xs-12" id="contenu_acceuil">
                    <img alt="Activités" src="img/acceuil/activites.jpg" class="img-rounded float">
                    <h3>Nos activités :</h3>
                    <br/>
                    <p class="p1 lead">
                ...
                <div class="col-md-6 column col-xs-12" id="contenu_acceuil">
                    <img alt="Localisation" src="img/acceuil/localisation.jpg" class="img-rounded float">
    ...
    <!-- Callout-->
    <div class="container_callout" id="passion">
    ...
    <!-- Call to Action -->
    <div class="call-to-action" id="anims">
        <div class="container">
            <div class="row">
                <div class="col-md-4 col-md-offset-4 text-center">
            ...
            <div class="row">
                <div class="col-md-10 col-md-offset-1">
                    <div class="vert-text">
                        <div id="team_25">
                            <img class="img-responsive team_25" src="img/team_25.png" alt="Staff 25ème">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row whitefirst">
                <div class="col-md-4 col-xs-12">
                    <img alt="Adam" src="img/id_pastilles/adam.jpg" class="img-thumbnail float">
                    <address>
                        <strong>Responsable d'Unité:</strong>
                        <br> <a href="http://fr.wikipedia.org/wiki/Buse_variable" target="new">Butéo</a>
                        <br> Adam Cambier
